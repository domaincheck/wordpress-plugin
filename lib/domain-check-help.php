...
class DomainCheckHelp {
	...
	public static function init() {
		...
		<?php
		static::$data['overview'] = ob_get_contents();
		ob_end_clean();
		...
		<br><br>
		<?php
		static::$data['page_faq'] = ob_get_contents();
		ob_end_clean();
		...
		<?php
		static::$data['page_dashboard'] = ob_get_contents();
		ob_end_clean();
		...
		<?php
		static::$data['page_your_domains'] = ob_get_contents();
		ob_end_clean();
		...
		<?php
		static::$data['page_domain_search'] = ob_get_contents();
		ob_end_clean();
		...
		<?php
		static::$data['page_domain_watch'] = ob_get_contents();
		ob_end_clean();
		...
		<?php
		static::$data['page_ssl_check'] = ob_get_contents();
		ob_end_clean();
		...
		<?php
		static::$data['page_ssl_watch'] = ob_get_contents();
		ob_end_clean();
		...
		<?php
		static::$data['page_import_export'] = ob_get_contents();
		ob_end_clean();
		...
		<?php
		static::$data['page_settings'] = ob_get_contents();
		ob_end_clean();
		...
		<?php
		static::$data['page_coupons'] = ob_get_contents();
		ob_end_clean();
